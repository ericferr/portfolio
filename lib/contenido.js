...
export const casos = [
  {
    ...
    problema:
      'Un dropshipper elige qué vender a ciegas: invierte en publicidad y recién sabe si acertó cuando ya gastó. DropTrend le muestra, por país, qué productos del catálogo de su proveedor tienen demanda real, con datos actualizados todos los días.',
    construi:
      'Todo el producto, de punta a punta: la captura diaria de datos en 12 países, el motor de ranking, el panel (ranking, historial de producto, análisis con IA), la publicación automática en Instagram con aprobación humana, y un bot de WhatsApp con IA que responde a los clientes de cada usuario con los datos reales de sus productos.',
  ...
  },
  {
    ...
    enlaces: [{ texto: 'Entrar a la demo', href: 'https://tiendajoyeriasosa.infinityfreeapp.com/login.php' }],
    galeria: [
